...
# ==============================================================================
# 5. [ì¶”ê???ë¶€ë¶? Resource Rescue (CSS/?„ì´ì½?ê°•ì œ ë³µì‚¬)
# ==============================================================================
Write-Host ">>> ?š‘ Copying missing CSS/Assets..." -ForegroundColor Cyan
...
if (Test-Path $SrcMedia) {
    ...
    Write-Host "   ? ï¸ Warning: Media folder not found at $SrcMedia" -ForegroundColor Yellow
}
# ==============================================================================
